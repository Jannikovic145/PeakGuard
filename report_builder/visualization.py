...
from .config import PeakGuardColors, DEFAULT_CONFIG
...
# CHART-KONFIGURATION
# ============================================================================
# Hochauflösende Ausgabe für PDF (300 DPI = Druckqualität)
CHART_DPI = DEFAULT_CONFIG.chart_dpi  # 300 DPI aus config
CHART_FORMAT = 'png'
...
def make_timeseries_plot(df_15: pd.DataFrame, cap_kw: float) -> Path:
    ...
    plt.tight_layout()
    plt.savefig(tmp, dpi=CHART_DPI, bbox_inches='tight')
    plt.close()
    return tmp
